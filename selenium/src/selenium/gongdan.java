...
//1.工单 
       // 登陆
        driver.get("http://d.mdc.product/DefectiveReasons");//打开指定的网站
...
//      System.out.println(driver.getCurrentUrl());
    ...
    driver.findElement(By.className("save-button")).click();
        ...
        //产品
      driver.get("http://d.mdc.product/Product");//打开指定的网站
//      driver.manage().window().maximize();
//      driver.findElement(By.name("usernameOrEmailAddress")).sendKeys(new  String[] {"admin"});
//      driver.findElement(By.name("password")).sendKeys(new  String[] {"123qwe"});
//      driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/form/div[4]/div[2]/button")).click(); //点击按扭
//      System.out.println(driver.getCurrentUrl());
      ...
      checkboxs4.get(1).sendKeys("123"+str4);
        ...
        //标准用时
      driver.get("http://d.mdc.product/StandardTime");//打开指定的网站
//      driver.manage().window().maximize();
//      driver.findElement(By.name("usernameOrEmailAddress")).sendKeys(new  String[] {"admin"});
//      driver.findElement(By.name("password")).sendKeys(new  String[] {"123qwe"});
//      driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/form/div[4]/div[2]/button")).click(); //点击按扭
//      System.out.println(driver.getCurrentUrl());
      ...
      //工艺
      driver.get("http://d.mdc.product/Craft");//打开指定的网站
//      driver.manage().window().maximize();
//      driver.findElement(By.name("usernameOrEmailAddress")).sendKeys(new  String[] {"admin"});
//      driver.findElement(By.name("password")).sendKeys(new  String[] {"123qwe"});
//      driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/form/div[4]/div[2]/button")).click(); //点击按扭
//      System.out.println(driver.getCurrentUrl());
      ...
      //设备换产
        driver.get("http://d.mdc.product/MachineProcess");//打开指定的网站
//      driver.manage().window().maximize();
//      driver.findElement(By.name("usernameOrEmailAddress")).sendKeys(new  String[] {"admin"});
//      driver.findElement(By.name("password")).sendKeys(new  String[] {"123qwe"});
//      driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/form/div[4]/div[2]/button")).click(); //点击按扭
//      System.out.println(driver.getCurrentUrl());
      ...
      selenium.time2();
        ...
        //生产计划
        driver.get("http://d.mdc.product/ProductionPlan");//打开指定的网站
//      driver.manage().window().maximize();
//      driver.findElement(By.name("usernameOrEmailAddress")).sendKeys(new  String[] {"admin"});
//      driver.findElement(By.name("password")).sendKeys(new  String[] {"123qwe"});
//      driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/form/div[4]/div[2]/button")).click(); //点击按扭
