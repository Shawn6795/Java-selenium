...
public class chanliang {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					chanliang window = new chanliang();
	...
	private void initialize() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(rdbtnNewRadioButton.isSelected()) {
				chanliang_algorithm.MachineCode=textField.getText();
				chanliang_algorithm.time=textField_1.getText();
				chanliang_algorithm.programname=textField_2.getText();
				chanliang_algorithm.main(null);
			    textField_3.setText(" "+chanliang_algorithm.Ysum);
			    for(int j=0;j<100;j++) {
				...
				chanliang_algorithm.time=textField_1.getText();
				chanliang_algorithm.programname=textField_2.getText();
				chanliang_algorithm.banciname=textField_4.getText();
			    chanliang_algorithm.main(null);
			    textField_3.setText(" "+chanliang_algorithm.BYsum);
